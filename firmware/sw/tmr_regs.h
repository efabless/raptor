...
#define     TMR_STATUS_REG      0x00000010
#define     TMR_CTRL_REG        0x00000020
...
#define     TMR_EN_BIT          0x1
#define     TMR_EN_SIZE         0x1



unsigned int volatile * const TMR_CTRL = (unsigned int *) (TIMER_BASE_ADDR_0 + TMR_CTRL_REG);
